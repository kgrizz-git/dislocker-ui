...
- Unit tests for the Mount/Unmount tkinter UI (mocked deps, disks, and runner).

### Changed

- Local coverage gate raised to **80%** (aligned with SonarCloud); GUI module
  included in measured coverage (`runner` / `__main__` still omitted).
